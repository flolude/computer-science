...
\subsection*{a)}
$T(n)=5\cdot T(\frac{n}{2})+n\sqrt{n}$
\vspace*{1\baselineskip}

\subsection*{b)}
$T(n)=16\cdot T(\frac{n}{8})+n^{\frac{4}{3}}$
\vspace*{1\baselineskip}

\subsection*{c)}
$T(n)=5\cdot T(\frac{n}{7})+n\text{ log }n$
\vspace*{1\baselineskip}

\subsection*{d)}
$T(n)=2\cdot T(\frac{n}{4})+3n^{\frac{1}{4}}+\text{ log }n$
\vspace*{1\baselineskip}

\subsection*{e)}
$T(n)=16\cdot T(\frac{n}{4})+n^2\text{ log }n$
